...
public class Searching {
	...
	//Q: Why would a FOREACH loop not do the job here?
	//A: Because you need i to call hArr[i] 
	...
	//initialize Comparable array
	for( int i = 0; i < cArr.length; i++ ) {
	    cArr[i] = new Hexadecimal( (int)(100 * Math.random()) );
	}

	printArray( cArr ); //should now show Hexadecimal numbers
	...
	//search for 5 in array
	System.out.println( linSearch(cArr, new Hexadecimal(5) ) );
